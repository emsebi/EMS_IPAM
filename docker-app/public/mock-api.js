(() => {
  ...
  const bootstrap = {
    ...
    moduleCatalog: [
      ...
      { id:"radio", name:"رادیوها", description:"AP / Station", installed:false },
  ...
  const data = {
    ...
    hosts: [
      ...
      { id: "h3", ip: "198.18.3.11", name: "AP-Home", status: "active", type: "رادیو", os: "RouterOS", mac: "74:4D:28:10:20:30", vlan: "120", username: "admin", owner: "شبکه", location: "Demo Building A", vendor: "MikroTik", model: "NetMetal", radioMode: "ap", ssid: "EMS-Backhaul", frequency: "5805 MHz", channel: "40 MHz", signal: "", monitorEnabled: true, monitorState: { online: true, stations: [{ mac: "74:4D:28:AA:01:01" }, { mac: "74:4D:28:AA:01:02" }] }, monitorCheckedAt: new Date().toISOString(), monitorFailures: 0, notes: "", ports: { MIK: 8291 }, connectionMethods: [{ type: "WINBOX" }, { type: "SSH" }], devicePorts: [{ id: "port-h3", hostId: "h3", name: "ether1", description: "PoE", portType: "ethernet", speed: "1G", vlan: "120" }] },
      { id: "h4", ip: "198.18.3.12", name: "Station-Warehouse", status: "active", type: "رادیو", os: "RouterOS", mac: "74:4D:28:AA:01:01", vlan: "120", username: "admin", owner: "شبکه", location: "Demo Warehouse", vendor: "MikroTik", model: "LHG", radioMode: "station", ssid: "EMS-Backhaul", radioParentHostId: "h3", frequency: "5805 MHz", signal: "-58 dBm", monitorState: { online: true }, monitorCheckedAt: new Date().toISOString(), monitorFailures: 0, notes: "", ports: { MIK: 8291 }, connectionMethods: [{ type: "WINBOX" }], devicePorts: [] },
      { id: "h5", ip: "198.18.3.13", name: "Station-Office-2", status: "active", type: "رادیو", os: "RouterOS", mac: "74:4D:28:AA:01:02", vlan: "120", username: "admin", owner: "شبکه", location: "Demo Office", vendor: "MikroTik", model: "SXTsq", radioMode: "station", ssid: "EMS-Backhaul", radioParentHostId: "h3", frequency: "5805 MHz", channel: "40 MHz", signal: "-66 dBm", monitorState: { online: true }, monitorCheckedAt: new Date().toISOString(), monitorFailures: 0, notes: "", ports: { MIK: 8291, SSH: 22 }, connectionMethods: [{ type: "WINBOX" }, { type: "SSH" }], devicePorts: [] },
      { id: "h6", ip: "198.18.4.11", name: "AP-Branch", status: "active", type: "رادیو", os: "RouterOS", mac: "74:4D:28:20:30:40", vlan: "140", username: "admin", owner: "شبکه", location: "Demo Branch", vendor: "MikroTik", model: "NetBox", radioMode: "ap", ssid: "EMS-Branch", frequency: "5745 MHz", channel: "20 MHz", signal: "", monitorEnabled: true, monitorState: { online: true }, monitorCheckedAt: new Date().toISOString(), monitorFailures: 0, notes: "", ports: { MIK: 8291, SSH: 22 }, connectionMethods: [{ type: "WINBOX" }, { type: "SSH" }], devicePorts: [] },
      { id: "h7", ip: "198.18.4.12", name: "Station-Branch-1", status: "active", type: "رادیو", os: "RouterOS", mac: "74:4D:28:AA:02:01", vlan: "140", username: "admin", owner: "شبکه", location: "Demo Customer Site", vendor: "MikroTik", model: "LHG", radioMode: "station", ssid: "EMS-Branch", radioParentHostId: "h6", frequency: "5745 MHz", channel: "20 MHz", signal: "-61 dBm", monitorState: { online: true }, monitorCheckedAt: new Date().toISOString(), monitorFailures: 0, notes: "", ports: { MIK: 8291 }, connectionMethods: [{ type: "WINBOX" }], devicePorts: [] },
      { id: "h8", ip: "198.18.5.20", name: "Station-Unlinked", status: "reserved", type: "رادیو", os: "RouterOS", mac: "", vlan: "", username: "", owner: "شبکه", location: "نامشخص", vendor: "MikroTik", model: "", radioMode: "station", ssid: "", radioParentHostId: null, frequency: "", channel: "", signal: "", notes: "نیازمند اتصال به AP", ports: { MIK: 8291 }, connectionMethods: [{ type: "WINBOX" }], devicePorts: [] },
    ],
    pings: [
